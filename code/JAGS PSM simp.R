model {
  ...
  BScyst.slope.lw.2H = 0.34
  
  # BScyst.slope.diet.2H ~ dnorm(0.26, 1/0.025^2)
  
  BScyst.slope.diet.2H = 0.26
  ...
  BScyst.slope.lw.18O = 0.692
  
  # BScyst.slope.diet.18O ~ dnorm(0.101, 1/0.017^2)
  
  BScyst.slope.diet.18O = 0.101
  ...
  #f: fraction of advected air over lake, Tanganyika is set at 0.3, GSL is set at the same value
  f = 0.3
  # f ~ dbeta(20, 40) #(20, 50)
  ...
  rh ~ dbeta(40, 85) T(0.1,0.5) #(40, 72)
