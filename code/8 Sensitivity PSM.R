...
#Run it
PSM.evap.CG = do.call(jags.parallel,list(model.file = "code/JAGS PSM full CG.R", 
...
write.csv(PSM.evap.CG$BUGSoutput$summary, "out/PSM_evap_CG_sum.csv")

PSM.evap.CG$BUGSoutput$summary

par(mfrow=c(3,3))
#check relative humidity
plot(density(PSM.evap.CG$BUGSoutput$sims.list$rh),main="RH") #getting low

#check advection coefficient
plot(density(PSM.evap.CG$BUGSoutput$sims.list$f),main="F convection") #

#check wind speed
plot(density(PSM.evap.CG$BUGSoutput$sims.list$nsws),main="Wind") #normal

# check brine shrimp cyst intercept
plot(density(PSM.evap.CG$BUGSoutput$sims.list$BScyst.inc.2H),main="Cyst d2H interc")
abline(v=-92) #ok

#check brine shrimp cyst slopes
plot(density(PSM.evap.CG$BUGSoutput$sims.list$BScyst.slope.lw.2H),main="Cyst lw d2H slope")
abline(v=0.34) #ok

#check brine shrimp cyst intercept
plot(density(PSM.evap.CG$BUGSoutput$sims.list$BScyst.slope.diet.2H),main="Cyst diet d2H slope")
abline(v=0.26) #0.2

#check brine shrimp cyst intercept
plot(density(PSM.evap.CG$BUGSoutput$sims.list$BScyst.inc.18O),main="Cyst d18O interc")
abline(v=15.9)#ok
#check brine shrimp cyst slopes
plot(density(PSM.evap.CG$BUGSoutput$sims.list$BScyst.slope.lw.18O),main="Cyst lw d18O slope")
abline(v=0.692)#ok
#check brine shrimp cyst intercept
plot(density(PSM.evap.CG$BUGSoutput$sims.list$BScyst.slope.diet.18O),main="Cyst diet d18O slope")
abline(v=0.101)#ok

plot(density(PSM.evap.CG$BUGSoutput$sims.list$d2H.gap.MAP_Ro),main="MAP Ro gap") 
abline(v=45)

#epsilon BS diet (smaller than pure algea, means that there is trophic enrichment?)
plot(density(PSM.evap.CG$BUGSoutput$sims.list$epsilon.2H.carbohy),main="2H carbohy ep") 
abline(v=-100)#likely a mixture of both algae and terrestrial/wetland POM

plot(density(PSM.evap.CG$BUGSoutput$sims.list$epsilon.18O.carbohy),main="18O carbohy ep") 
abline(v=27) #much lower for d18O!

plot(density(PSM.evap.CG$BUGSoutput$sims.list$lcwax.d2H.inc),main="lc MAP inc") 
abline(v=-125) #much smaller than -129, at -115!, mixing with a -170 per mil source?

plot(density(PSM.evap.CG$BUGSoutput$sims.list$lcwax.d2H.slope),main="lc MAP slope")
abline(v=0.62) #0.76
...
t <- length(PSM.s.wo.ex.scalpha[[1]])

PSM.s.wo.ex.scalpha <- MCMC.CI.bound(PSM.s.wo.ex$BUGSoutput$sims.list$alpha2H.sc.alkane,0.89)
plot(length(PSM.s.wo.ex.scalpha[[1]]):1*age.res, PSM.s.wo.ex.scalpha[[1]],type="l",ylim=c(0.8,1), main="sc alpha")
lines(length(PSM.s.wo.ex.scalpha[[1]]):1*age.res,PSM.s.wo.ex.scalpha[[2]],lty=2)
lines(length(PSM.s.wo.ex.scalpha[[1]]):1*age.res,PSM.s.wo.ex.scalpha[[3]],lty=2)
...
################Sensitivity of PSM with the following elements:###############probable
#error term using 1/2 pairwise difference 
...
par(mfrow=c(3,3))
#check relative humidity
plot(density(PSM.Tcov$BUGSoutput$sims.list$rh),main="RH") #getting low

#check advection coefficient
plot(density(PSM.Tcov$BUGSoutput$sims.list$f),main="F convection") #

#check wind speed
plot(density(PSM.Tcov$BUGSoutput$sims.list$nsws),main="Wind") #normal

# check brine shrimp cyst intercept
plot(density(PSM.Tcov$BUGSoutput$sims.list$BScyst.inc.2H),main="Cyst d2H interc")
abline(v=-92) #ok

#check brine shrimp cyst slopes
plot(density(PSM.Tcov$BUGSoutput$sims.list$BScyst.slope.lw.2H),main="Cyst lw d2H slope")
abline(v=0.34) #ok

#check brine shrimp cyst intercept
plot(density(PSM.Tcov$BUGSoutput$sims.list$BScyst.slope.diet.2H),main="Cyst diet d2H slope")
abline(v=0.26) #0.2

#check brine shrimp cyst intercept
plot(density(PSM.Tcov$BUGSoutput$sims.list$BScyst.inc.18O),main="Cyst d18O interc")
abline(v=15.9)#ok
#check brine shrimp cyst slopes
plot(density(PSM.Tcov$BUGSoutput$sims.list$BScyst.slope.lw.18O),main="Cyst lw d18O slope")
abline(v=0.692)#ok
#check brine shrimp cyst intercept
plot(density(PSM.Tcov$BUGSoutput$sims.list$BScyst.slope.diet.18O),main="Cyst diet d18O slope")
abline(v=0.101)#ok

plot(density(PSM.Tcov$BUGSoutput$sims.list$d2H.gap.MAP_Ro),main="MAP Ro gap") 
abline(v=45)

#epsilon BS diet (smaller than pure algea, means that there is trophic enrichment?)
plot(density(PSM.Tcov$BUGSoutput$sims.list$epsilon.2H.carbohy),main="2H carbohy ep") 
abline(v=-100)#likely a mixture of both algae and terrestrial/wetland POM

plot(density(PSM.Tcov$BUGSoutput$sims.list$epsilon.18O.carbohy),main="18O carbohy ep") 
abline(v=27) #much lower for d18O!

plot(density(PSM.Tcov$BUGSoutput$sims.list$lcwax.d2H.inc),main="lc MAP inc") 
abline(v=-125) #much smaller than -129, at -115!, mixing with a -170 per mil source?

plot(density(PSM.Tcov$BUGSoutput$sims.list$lcwax.d2H.slope),main="lc MAP slope")
abline(v=0.62) #0.76

plot(density(PSM.Tcov$BUGSoutput$sims.list$scwax.alpha.sl),main="sc alpha slope")
abline(v=0.0008)#0.0009

plot(density(PSM.Tcov$BUGSoutput$sims.list$scwax.alpha.inc),main="sc alpha interc")
abline(v=0.80745) # Consider make this fixed
#Or remove this relationship!

plot(density(PSM.Tcov$BUGSoutput$sims.list$f.m.ro),main="f.m.ro") #more like 0.4
abline(v=0.2) 

plot(density(PSM.Tcov$BUGSoutput$sims.list$f.C14d.carb),main="f.C14d.carb") #ok
abline(v=0.05) 

plot(density(PSM.Tcov$BUGSoutput$sims.list$f.C14d.lcwax),main="f.C14d.lcwax") #ok
abline(v=0.01) 

plot(density(PSM.Tcov$BUGSoutput$sims.list$epsilon.alk.acid),main="epsilon.alk.acid") #ok
abline(v=25)

plot(density(PSM.Tcov$BUGSoutput$sims.list$T.cps.slope), main="T.cps.slope")

plot(density(PSM.Tcov$BUGSoutput$sims.list$tl), main="Date aligned")

plot(density(PSM.Tcov$BUGSoutput$sims.list$n.d.evap), main="n.d.evap")

PSM.Tcov.scalpha <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$alpha2H.sc.alkane,0.89)
plot(t:1*age.res, PSM.Tcov.scalpha[[1]],type="l",ylim=c(0.8,1), main="sc alpha")
lines(t:1*age.res,PSM.Tcov.scalpha[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.scalpha[[3]],lty=2)

PSM.Tcov.prx.sal <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$prx.sal,0.89)
plot(t:1*age.res, PSM.Tcov.prx.sal[[1]],type="l",ylim=c(0,200), main="pre sal")
lines(t:1*age.res,PSM.Tcov.prx.sal[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.prx.sal[[3]],lty=2)

PSM.Tcov.prx.L.d2H <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$prx.L.d2H,0.89)
plot(t:1*age.res, PSM.Tcov.prx.L.d2H[[1]],type="l",ylim=c(-150,0), main="prx L d2H")
lines(t:1*age.res,PSM.Tcov.prx.L.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.prx.L.d2H[[3]],lty=2)

#check LST
PSM.Tcov.LST <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$LST,0.89)
plot(t:1*age.res,PSM.Tcov.LST[[1]],type="l",ylim=c(5,30), main="LST")
lines(t:1*age.res,PSM.Tcov.LST[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.LST[[3]],lty=2)
#by far, temperature has the least constraint, still too high!

#check AT
PSM.Tcov.AT <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$AT,0.89)
plot(t:1*age.res,PSM.Tcov.AT[[1]],type="l",ylim=c(20,40), main="AT")
lines(t:1*age.res,PSM.Tcov.AT[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.AT[[3]],lty=2)

#check Runoff and evaporation
PSM.Tcov.Runoff <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$Runoff,0.89)
plot(t:1*age.res,PSM.Tcov.Runoff[[1]],type="l",ylim=c(0,12), main="Runoff and Evap")
lines(t:1*age.res,PSM.Tcov.Runoff[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.Runoff[[3]],lty=2)

#check evaporation
PSM.Tcov.Evap <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$Evap,0.89)
lines(t:1*age.res,PSM.Tcov.Evap[[1]],col="red")
lines(t:1*age.res,PSM.Tcov.Evap[[2]],lty=2,col="red")
lines(t:1*age.res,PSM.Tcov.Evap[[3]],lty=2,col="red")

#check evaporation rate
PSM.Tcov.Evaprate <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$E.rate,0.89)
plot(t:1*age.res,PSM.Tcov.Evaprate[[1]],type="l",main="Evap rate", ylim=c(0,2))
lines(t:1*age.res,PSM.Tcov.Evaprate[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.Evaprate[[3]],lty=2)

#check lake level
PSM.Tcov.L.level <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$L.level,0.89)
plot(t:1*age.res,PSM.Tcov.L.level[[1]],type="l",ylim=c(1276,1286), main="Lake level")
lines(t:1*age.res,PSM.Tcov.L.level[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.L.level[[3]],lty=2)

#check salinity
PSM.Tcov.sal <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$sal,0.89)
plot(t:1*age.res,PSM.Tcov.sal[[1]],type="l",ylim=c(50,360), main="salinity")
lines(t:1*age.res,PSM.Tcov.sal[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.sal[[3]],lty=2)

#check runoff isotopes
PSM.Tcov.Rod18O <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$Ro.d18O,0.89)
plot(t:1*age.res,PSM.Tcov.Rod18O[[1]],type="l",ylim=c(-25,-10), main="Runoff d18O")
lines(t:1*age.res,PSM.Tcov.Rod18O[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.Rod18O[[3]],lty=2)

PSM.Tcov.Rod2H <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$Ro.d2H,0.89)
plot(t:1*age.res,PSM.Tcov.Rod2H[[1]],type="l",ylim=c(-180,-80), main="Runoff d2H")
lines(t:1*age.res,PSM.Tcov.Rod2H[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.Rod2H[[3]],lty=2)

#check evaporation isotopes
PSM.Tcov.evap.d18O <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$evap.d18O,0.89)
plot(t:1*age.res,PSM.Tcov.evap.d18O[[1]],type="l",ylim=c(-25,-10), main="Evap d18O")
lines(t:1*age.res,PSM.Tcov.evap.d18O[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.evap.d18O[[3]],lty=2)

PSM.Tcov.evap.d2H <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$evap.d2H,0.89)
plot(t:1*age.res,PSM.Tcov.evap.d2H[[1]],type="l",ylim=c(-180,-80), main="Evap d2H")
lines(t:1*age.res,PSM.Tcov.evap.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.evap.d2H[[3]],lty=2)

#check lake water isotopes
PSM.Tcov.Lw.d18O <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$Lw.d18O,0.89)
plot(t:1*age.res,PSM.Tcov.Lw.d18O[[1]],type="l",ylim=c(-10,0), main="Lake water d18O")
lines(t:1*age.res,PSM.Tcov.Lw.d18O[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.Lw.d18O[[3]],lty=2)

PSM.Tcov.Lw.d2H <- MCMC.CI.bound(PSM.Tcov$BUGSoutput$sims.list$Lw.d2H,0.89)
plot(t:1*age.res,PSM.Tcov.Lw.d2H[[1]],type="l",ylim=c(-100,0), main="Lake water d2H")
lines(t:1*age.res,PSM.Tcov.Lw.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.Tcov.Lw.d2H[[3]],lty=2)
...
###############################test sensitivity to brine shrimp in pre-mixed water#################3
####### compile measured data#####
#use half pairwise difference as uncertainty around the mean#
...
#Run it
PSM.BS.pre = do.call(jags.parallel,list(model.file = "code/JAGS PSM full BS pre.R", 
                                         parameters.to.save = parameters, 
                                         data = dat, n.chains=5, n.iter = n.iter, 
                                         n.burnin = n.burnin, n.thin = n.thin))
...
write.csv(PSM.BS.pre$BUGSoutput$summary, "out/PSM.BS.pre_sum.csv")

PSM.BS.pre$BUGSoutput$summary

par(mfrow=c(3,3))
#check relative humidity
plot(density(PSM.BS.pre$BUGSoutput$sims.list$rh),main="RH") #getting low

#check advection coefficient
plot(density(PSM.BS.pre$BUGSoutput$sims.list$f),main="F convection") #

#check wind speed
plot(density(PSM.BS.pre$BUGSoutput$sims.list$nsws),main="Wind") #normal

#check LST ac
plot(density(PSM.BS.pre$BUGSoutput$sims.list$LST.pre),main="LST pre") #very high!

#check Ro ac
plot(density(PSM.BS.pre$BUGSoutput$sims.list$Ro.d18O.cps),main="Ro ac")

#check atm vapor d18O
plot(density(PSM.BS.pre$BUGSoutput$sims.list$air.d18O),main="Atm d18O") 
abline(v=d18O.vap.warm)

# check brine shrimp cyst intercept
plot(density(PSM.BS.pre$BUGSoutput$sims.list$BScyst.inc.2H),main="Cyst d2H interc")
abline(v=-92) #ok

#check brine shrimp cyst slopes
plot(density(PSM.BS.pre$BUGSoutput$sims.list$BScyst.slope.lw.2H),main="Cyst lw d2H slope")
abline(v=0.34) #ok

#check brine shrimp cyst intercept
plot(density(PSM.BS.pre$BUGSoutput$sims.list$BScyst.slope.diet.2H),main="Cyst diet d2H slope")
abline(v=0.26) #0.2

#check brine shrimp cyst intercept
plot(density(PSM.BS.pre$BUGSoutput$sims.list$BScyst.inc.18O),main="Cyst d18O interc")
abline(v=15.9)#ok
#check brine shrimp cyst slopes
plot(density(PSM.BS.pre$BUGSoutput$sims.list$BScyst.slope.lw.18O),main="Cyst lw d18O slope")
abline(v=0.692)#ok
#check brine shrimp cyst intercept
plot(density(PSM.BS.pre$BUGSoutput$sims.list$BScyst.slope.diet.18O),main="Cyst diet d18O slope")
abline(v=0.101)#ok

plot(density(PSM.BS.pre$BUGSoutput$sims.list$d2H.gap.MAP_Ro),main="MAP Ro gap") 
abline(v=45)

#epsilon BS diet (smaller than pure algea, means that there is trophic enrichment?)
plot(density(PSM.BS.pre$BUGSoutput$sims.list$epsilon.2H.carbohy),main="2H carbohy ep") 
abline(v=-100)#likely a mixture of both algae and terrestrial/wetland POM

plot(density(PSM.BS.pre$BUGSoutput$sims.list$epsilon.18O.carbohy),main="18O carbohy ep") 
abline(v=27) #much lower for d18O!

plot(density(PSM.BS.pre$BUGSoutput$sims.list$lcwax.d2H.inc),main="lc MAP inc") 
abline(v=-125) #much smaller than -129, at -115!, mixing with a -170 per mil source?

plot(density(PSM.BS.pre$BUGSoutput$sims.list$lcwax.d2H.slope),main="lc MAP slope")
abline(v=0.62) #0.76

plot(density(PSM.BS.pre$BUGSoutput$sims.list$scwax.alpha.sl),main="sc alpha slope")
abline(v=0.0008)#0.0009

plot(density(PSM.BS.pre$BUGSoutput$sims.list$scwax.alpha.inc),main="sc alpha interc")
abline(v=0.80745) # Consider make this fixed
#Or remove this relationship!

plot(density(PSM.BS.pre$BUGSoutput$sims.list$f.m.ro),main="f.m.ro") #more like 0.4
abline(v=0.2) 

plot(density(PSM.BS.pre$BUGSoutput$sims.list$f.C14d.carb),main="f.C14d.carb") #ok
abline(v=0.05) 

plot(density(PSM.BS.pre$BUGSoutput$sims.list$f.C14d.lcwax),main="f.C14d.lcwax") #ok
abline(v=0.01) 

plot(density(PSM.BS.pre$BUGSoutput$sims.list$epsilon.alk.acid),main="epsilon.alk.acid") #ok
abline(v=25)

plot(density(PSM.BS.pre$BUGSoutput$sims.list$T.cps.slope), main="T.cps.slope")

plot(density(PSM.BS.pre$BUGSoutput$sims.list$tl), main="Date aligned")

plot(density(PSM.BS.pre$BUGSoutput$sims.list$n.d.evap), main="n.d.evap")

PSM.BS.pre.scalpha <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$alpha2H.sc.alkane,0.89)
plot(t:1*age.res, PSM.BS.pre.scalpha[[1]],type="l",ylim=c(0.8,1), main="sc alpha")
lines(t:1*age.res,PSM.BS.pre.scalpha[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.scalpha[[3]],lty=2)

PSM.BS.pre.prx.sal <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$prx.sal,0.89)
plot(t:1*age.res, PSM.BS.pre.prx.sal[[1]],type="l",ylim=c(0,200), main="pre sal")
lines(t:1*age.res,PSM.BS.pre.prx.sal[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.prx.sal[[3]],lty=2)

PSM.BS.pre.prx.L.d2H <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$prx.L.d2H,0.89)
plot(t:1*age.res, PSM.BS.pre.prx.L.d2H[[1]],type="l",ylim=c(-150,0), main="prx L d2H")
lines(t:1*age.res,PSM.BS.pre.prx.L.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.prx.L.d2H[[3]],lty=2)

#check LST
PSM.BS.pre.LST <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$LST,0.89)
plot(t:1*age.res,PSM.BS.pre.LST[[1]],type="l",ylim=c(15,30), main="LST")
lines(t:1*age.res,PSM.BS.pre.LST[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.LST[[3]],lty=2)
#by far, temperature has the least constraint, still too high!

#check AT
PSM.BS.pre.AT <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$AT,0.89)
plot(t:1*age.res,PSM.BS.pre.AT[[1]],type="l",ylim=c(20,40), main="AT")
lines(t:1*age.res,PSM.BS.pre.AT[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.AT[[3]],lty=2)

#check Runoff and evaporation
PSM.BS.pre.Runoff <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$Runoff,0.89)
plot(t:1*age.res,PSM.BS.pre.Runoff[[1]],type="l",ylim=c(0,12), main="Runoff and Evap")
lines(t:1*age.res,PSM.BS.pre.Runoff[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.Runoff[[3]],lty=2)

#check evaporation
PSM.BS.pre.Evap <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$Evap,0.89)
lines(t:1*age.res,PSM.BS.pre.Evap[[1]],col="red")
lines(t:1*age.res,PSM.BS.pre.Evap[[2]],lty=2,col="red")
lines(t:1*age.res,PSM.BS.pre.Evap[[3]],lty=2,col="red")

#check evaporation rate
PSM.BS.pre.Evaprate <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$E.rate,0.89)
plot(t:1*age.res,PSM.BS.pre.Evaprate[[1]],type="l",main="Evap rate", ylim=c(0,2))
lines(t:1*age.res,PSM.BS.pre.Evaprate[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.Evaprate[[3]],lty=2)

#check lake level
PSM.BS.pre.L.level <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$L.level,0.89)
plot(t:1*age.res,PSM.BS.pre.L.level[[1]],type="l",ylim=c(1276,1286), main="Lake level")
lines(t:1*age.res,PSM.BS.pre.L.level[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.L.level[[3]],lty=2)

#check salinity
PSM.BS.pre.sal <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$sal,0.89)
plot(t:1*age.res,PSM.BS.pre.sal[[1]],type="l",ylim=c(50,360), main="salinity")
lines(t:1*age.res,PSM.BS.pre.sal[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.sal[[3]],lty=2)

#check runoff isotopes
PSM.BS.pre.Rod18O <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$Ro.d18O,0.89)
plot(t:1*age.res,PSM.BS.pre.Rod18O[[1]],type="l",ylim=c(-25,-10), main="Runoff d18O")
lines(t:1*age.res,PSM.BS.pre.Rod18O[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.Rod18O[[3]],lty=2)

PSM.BS.pre.Rod2H <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$Ro.d2H,0.89)
plot(t:1*age.res,PSM.BS.pre.Rod2H[[1]],type="l",ylim=c(-180,-80), main="Runoff d2H")
lines(t:1*age.res,PSM.BS.pre.Rod2H[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.Rod2H[[3]],lty=2)

#check evaporation isotopes
PSM.BS.pre.evap.d18O <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$evap.d18O,0.89)
plot(t:1*age.res,PSM.BS.pre.evap.d18O[[1]],type="l",ylim=c(-25,-10), main="Evap d18O")
lines(t:1*age.res,PSM.BS.pre.evap.d18O[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.evap.d18O[[3]],lty=2)

PSM.BS.pre.evap.d2H <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$evap.d2H,0.89)
plot(t:1*age.res,PSM.BS.pre.evap.d2H[[1]],type="l",ylim=c(-180,-80), main="Evap d2H")
lines(t:1*age.res,PSM.BS.pre.evap.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.evap.d2H[[3]],lty=2)

#check lake water isotopes
PSM.BS.pre.Lw.d18O <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$Lw.d18O,0.89)
plot(t:1*age.res,PSM.BS.pre.Lw.d18O[[1]],type="l",ylim=c(-10,0), main="Lake water d18O")
lines(t:1*age.res,PSM.BS.pre.Lw.d18O[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.Lw.d18O[[3]],lty=2)

PSM.BS.pre.Lw.d2H <- MCMC.CI.bound(PSM.BS.pre$BUGSoutput$sims.list$Lw.d2H,0.89)
plot(t:1*age.res,PSM.BS.pre.Lw.d2H[[1]],type="l",ylim=c(-100,0), main="Lake water d2H")
lines(t:1*age.res,PSM.BS.pre.Lw.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.BS.pre.Lw.d2H[[3]],lty=2)

plot(PSM.BS.pre.Lw.d18O[[1]],PSM.BS.pre.Lw.d2H[[1]],xlim=c(-25,5),ylim=c(-200,20))
abline(a=Lw.intc, b=Lw.slope) #ok
#check meteoric line
points(PSM.BS.pre.Rod18O[[1]],PSM.BS.pre.Rod2H[[1]])
abline(a=MWL.intc, b=MWL.slope)
points(PSM.BS.pre.evap.d18O[[1]],PSM.BS.pre.evap.d2H[[1]],col="red")

###############################test sensitivity to f.m.ro in pre-mixed water#################
#error term using 1/2 pairwise difference 
#no covariance between LST and Ro.d18O
#sc.wax record with n-C18
#with proximal lake mixing
...
#Run it
PSM.limitf = do.call(jags.parallel,list(model.file = "code/JAGS PSM full limitf.R", 
                                        parameters.to.save = parameters, 
                                        data = dat, n.chains=5, n.iter = n.iter, 
                                        n.burnin = n.burnin, n.thin = n.thin))
...
write.csv(PSM.limitf$BUGSoutput$summary, "out/PSM.limitf_sum.csv")

PSM.limitf$BUGSoutput$summary

par(mfrow=c(3,3))
#check relative humidity
plot(density(PSM.limitf$BUGSoutput$sims.list$rh),main="RH") #getting low

#check advection coefficient
plot(density(PSM.limitf$BUGSoutput$sims.list$f),main="F convection") #

#check wind speed
plot(density(PSM.limitf$BUGSoutput$sims.list$nsws),main="Wind") #normal

# check brine shrimp cyst intercept
plot(density(PSM.limitf$BUGSoutput$sims.list$BScyst.inc.2H),main="Cyst d2H interc")
abline(v=-92) #ok

#check brine shrimp cyst slopes
plot(density(PSM.limitf$BUGSoutput$sims.list$BScyst.slope.lw.2H),main="Cyst lw d2H slope")
abline(v=0.34) #ok

#check brine shrimp cyst intercept
plot(density(PSM.limitf$BUGSoutput$sims.list$BScyst.slope.diet.2H),main="Cyst diet d2H slope")
abline(v=0.26) #0.2

#check brine shrimp cyst intercept
plot(density(PSM.limitf$BUGSoutput$sims.list$BScyst.inc.18O),main="Cyst d18O interc")
abline(v=15.9)#ok
#check brine shrimp cyst slopes
plot(density(PSM.limitf$BUGSoutput$sims.list$BScyst.slope.lw.18O),main="Cyst lw d18O slope")
abline(v=0.692)#ok
#check brine shrimp cyst intercept
plot(density(PSM.limitf$BUGSoutput$sims.list$BScyst.slope.diet.18O),main="Cyst diet d18O slope")
abline(v=0.101)#ok

plot(density(PSM.limitf$BUGSoutput$sims.list$d2H.gap.MAP_Ro),main="MAP Ro gap") 
abline(v=45)

#epsilon BS diet (smaller than pure algea, means that there is trophic enrichment?)
plot(density(PSM.limitf$BUGSoutput$sims.list$epsilon.2H.carbohy),main="2H carbohy ep") 
abline(v=-100)#likely a mixture of both algae and terrestrial/wetland POM

plot(density(PSM.limitf$BUGSoutput$sims.list$epsilon.18O.carbohy),main="18O carbohy ep") 
abline(v=27) #much lower for d18O!

plot(density(PSM.limitf$BUGSoutput$sims.list$lcwax.d2H.inc),main="lc MAP inc") 
abline(v=-125) #much smaller than -129, at -115!, mixing with a -170 per mil source?

plot(density(PSM.limitf$BUGSoutput$sims.list$lcwax.d2H.slope),main="lc MAP slope")
abline(v=0.62) #0.76

plot(density(PSM.limitf$BUGSoutput$sims.list$scwax.alpha.sl),main="sc alpha slope")
abline(v=0.0008)#0.0009

plot(density(PSM.limitf$BUGSoutput$sims.list$scwax.alpha.inc),main="sc alpha interc")
abline(v=0.80745) # Consider make this fixed
#Or remove this relationship!

plot(density(PSM.limitf$BUGSoutput$sims.list$f.m.ro),main="f.m.ro") #more like 0.4
abline(v=0.2) 

plot(density(PSM.limitf$BUGSoutput$sims.list$f.C14d.carb),main="f.C14d.carb") #ok
abline(v=0.05) 

plot(density(PSM.limitf$BUGSoutput$sims.list$f.C14d.lcwax),main="f.C14d.lcwax") #ok
abline(v=0.01) 

plot(density(PSM.limitf$BUGSoutput$sims.list$epsilon.alk.acid),main="epsilon.alk.acid") #ok
abline(v=25)

plot(density(PSM.limitf$BUGSoutput$sims.list$T.cps.slope), main="T.cps.slope")

plot(density(PSM.limitf$BUGSoutput$sims.list$tl), main="Date aligned")

plot(density(PSM.limitf$BUGSoutput$sims.list$n.d.evap), main="n.d.evap")

PSM.limitf.scalpha <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$alpha2H.sc.alkane,0.89)
plot(t:1*age.res, PSM.limitf.scalpha[[1]],type="l",ylim=c(0.8,1), main="sc alpha")
lines(t:1*age.res,PSM.limitf.scalpha[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.scalpha[[3]],lty=2)

PSM.limitf.prx.sal <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$prx.sal,0.89)
plot(t:1*age.res, PSM.limitf.prx.sal[[1]],type="l",ylim=c(0,200), main="pre sal")
lines(t:1*age.res,PSM.limitf.prx.sal[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.prx.sal[[3]],lty=2)

PSM.limitf.prx.L.d2H <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$prx.L.d2H,0.89)
plot(t:1*age.res, PSM.limitf.prx.L.d2H[[1]],type="l",ylim=c(-150,0), main="prx L d2H")
lines(t:1*age.res,PSM.limitf.prx.L.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.prx.L.d2H[[3]],lty=2)

#check LST
PSM.limitf.LST <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$LST,0.89)
plot(t:1*age.res,PSM.limitf.LST[[1]],type="l",ylim=c(15,30), main="LST")
lines(t:1*age.res,PSM.limitf.LST[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.LST[[3]],lty=2)
#by far, temperature has the least constraint, still too high!

#check AT
PSM.limitf.AT <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$AT,0.89)
plot(t:1*age.res,PSM.limitf.AT[[1]],type="l",ylim=c(20,40), main="AT")
lines(t:1*age.res,PSM.limitf.AT[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.AT[[3]],lty=2)

#check Runoff and evaporation
PSM.limitf.Runoff <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$Runoff,0.89)
plot(t:1*age.res,PSM.limitf.Runoff[[1]],type="l",ylim=c(0,12), main="Runoff and Evap")
lines(t:1*age.res,PSM.limitf.Runoff[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.Runoff[[3]],lty=2)

#check evaporation
PSM.limitf.Evap <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$Evap,0.89)
lines(t:1*age.res,PSM.limitf.Evap[[1]],col="red")
lines(t:1*age.res,PSM.limitf.Evap[[2]],lty=2,col="red")
lines(t:1*age.res,PSM.limitf.Evap[[3]],lty=2,col="red")

#check evaporation rate
PSM.limitf.Evaprate <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$E.rate,0.89)
plot(t:1*age.res,PSM.limitf.Evaprate[[1]],type="l",main="Evap rate", ylim=c(0,2))
lines(t:1*age.res,PSM.limitf.Evaprate[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.Evaprate[[3]],lty=2)

#check lake level
PSM.limitf.L.level <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$L.level,0.89)
plot(t:1*age.res,PSM.limitf.L.level[[1]],type="l",ylim=c(1276,1286), main="Lake level")
lines(t:1*age.res,PSM.limitf.L.level[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.L.level[[3]],lty=2)

#check salinity
PSM.limitf.sal <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$sal,0.89)
plot(t:1*age.res,PSM.limitf.sal[[1]],type="l",ylim=c(50,360), main="salinity")
lines(t:1*age.res,PSM.limitf.sal[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.sal[[3]],lty=2)

#check runoff isotopes
PSM.limitf.Rod18O <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$Ro.d18O,0.89)
plot(t:1*age.res,PSM.limitf.Rod18O[[1]],type="l",ylim=c(-25,-10), main="Runoff d18O")
lines(t:1*age.res,PSM.limitf.Rod18O[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.Rod18O[[3]],lty=2)

PSM.limitf.Rod2H <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$Ro.d2H,0.89)
plot(t:1*age.res,PSM.limitf.Rod2H[[1]],type="l",ylim=c(-180,-80), main="Runoff d2H")
lines(t:1*age.res,PSM.limitf.Rod2H[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.Rod2H[[3]],lty=2)

#check evaporation isotopes
PSM.limitf.evap.d18O <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$evap.d18O,0.89)
plot(t:1*age.res,PSM.limitf.evap.d18O[[1]],type="l",ylim=c(-25,-10), main="Evap d18O")
lines(t:1*age.res,PSM.limitf.evap.d18O[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.evap.d18O[[3]],lty=2)

PSM.limitf.evap.d2H <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$evap.d2H,0.89)
plot(t:1*age.res,PSM.limitf.evap.d2H[[1]],type="l",ylim=c(-180,-80), main="Evap d2H")
lines(t:1*age.res,PSM.limitf.evap.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.evap.d2H[[3]],lty=2)

#check lake water isotopes
PSM.limitf.Lw.d18O <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$Lw.d18O,0.89)
plot(t:1*age.res,PSM.limitf.Lw.d18O[[1]],type="l",ylim=c(-10,0), main="Lake water d18O")
lines(t:1*age.res,PSM.limitf.Lw.d18O[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.Lw.d18O[[3]],lty=2)

PSM.limitf.Lw.d2H <- MCMC.CI.bound(PSM.limitf$BUGSoutput$sims.list$Lw.d2H,0.89)
plot(t:1*age.res,PSM.limitf.Lw.d2H[[1]],type="l",ylim=c(-100,0), main="Lake water d2H")
lines(t:1*age.res,PSM.limitf.Lw.d2H[[2]],lty=2)
lines(t:1*age.res,PSM.limitf.Lw.d2H[[3]],lty=2)

plot(PSM.limitf.Lw.d18O[[1]],PSM.limitf.Lw.d2H[[1]],xlim=c(-25,5),ylim=c(-200,20))
abline(a=Lw.intc, b=Lw.slope) #ok
#check meteoric line
points(PSM.limitf.Rod18O[[1]],PSM.limitf.Rod2H[[1]])
abline(a=MWL.intc, b=MWL.slope)
points(PSM.limitf.evap.d18O[[1]],PSM.limitf.evap.d2H[[1]],col="red")